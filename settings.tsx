...
export const mintText = [
  { label: "SOL", mintText: "PAY SOL TO MINT", buttonLabel: "MINT WITH SOL", header: "SOL MINT" },
  { label: "AURA", mintText: "BURN AURA TO MINT", buttonLabel: "MINT WITH AURA", header: "AURA BURN MINT" }
];
